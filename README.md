...
* The three `.npy` files in the folder `data/` are the timestamp annotations provided by [Li et al.](https://github.com/ZheLi2020/TimestampActionSeg). Put each one in corresponding ground truth folder. For example, `data/breakfast/groundTruth/` for Breakfast dataset.
